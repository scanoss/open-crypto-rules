...
func main() {
	...
	ciphertext, _ := rsa.EncryptOAEP(crypto.SHA512.New(), rand.Reader, pubKey, plaintext, nil)
	decrypted, _ := rsa.DecryptOAEP(crypto.SHA512.New(), rand.Reader, key, ciphertext, nil)
	_ = decrypted
}
