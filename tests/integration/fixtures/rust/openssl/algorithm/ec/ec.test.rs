// TEST-METADATA: assetType=algorithm, findingType=signature, operation=instantiate, algorithmName=EC, algorithmFamily=EC, library=openssl, algorithmPrimitive=signature, ellipticCurve=Nid X9_62_PRIME256V1
...
// TEST-METADATA: assetType=algorithm, findingType=signature, operation=instantiate, algorithmName=EC, algorithmFamily=EC, library=openssl, algorithmPrimitive=signature, ellipticCurve=Nid SECP384R1
...
// TEST-METADATA: assetType=algorithm, findingType=signature, operation=instantiate, algorithmName=EC, algorithmFamily=EC, library=openssl, algorithmPrimitive=signature
...
// TEST-METADATA: assetType=algorithm, findingType=signature, operation=load, algorithmName=EC, algorithmFamily=EC, library=openssl, algorithmPrimitive=signature, keyFormat=PEM
...
// TEST-METADATA: assetType=algorithm, findingType=signature, operation=load, algorithmName=EC, algorithmFamily=EC, library=openssl, algorithmPrimitive=signature, keyFormat=DER
...
// TEST-METADATA: assetType=algorithm, findingType=signature, operation=serialize, algorithmName=EC, algorithmFamily=EC, library=openssl, algorithmPrimitive=signature, keyFormat=DER
...
// TEST-METADATA: assetType=algorithm, findingType=signature, operation=serialize, algorithmName=EC, algorithmFamily=EC, library=openssl, algorithmPrimitive=signature, keyFormat=PEM
...
// TEST-METADATA: assetType=algorithm, findingType=signature, operation=load, algorithmName=EC, algorithmFamily=EC, library=openssl, algorithmPrimitive=signature
